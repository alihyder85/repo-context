...
_LANGUAGE: Language = Language(tstypescript.language_typescript())


class TypeScriptParser(BaseParser):
    """Stateless parser for TypeScript / TSX files using tree-sitter."""
    ...
    def parse(self, file_meta: FileMetadata) -> ParsedFile:
        ...
        try:
            ...
            logger.warning("TypeScriptParser: cannot read {}: {}", file_meta.absolute_path, exc)
